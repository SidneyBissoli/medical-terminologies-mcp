...
| 11.7 | PR to `awesome-mcp-servers` (punkpeye + wong2 lists) | ~30 min | 🔄 prep complete 2026-05-11 — refreshed A.1 draft in [outreach-templates.md](./outreach-templates.md). **Scope reduced to punkpeye only**: wong2's repo is PR-restricted (0 open / 0 closed PRs ever, "Pull request creation is restricted" banner) — it's a curated list, not a community list. The success criterion says "merged in at least one" so punkpeye alone satisfies it | 11.1 + 11.3 |
